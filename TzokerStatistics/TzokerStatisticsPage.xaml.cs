...
{
    public partial class TzokerStatisticsPage : PhoneApplicationPage
    {
        public TzokerStatisticsPage()
        {
            InitializeComponent();
        ...
        {
            TzokerStatisticsList.ItemsSource = AnalyzeService.TzokerNumbersStatisticsList;
